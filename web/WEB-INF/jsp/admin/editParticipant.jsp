...
<form id="saveParticipantChangesForm" action="Controller" method="post">
...
<div class="container col-6 border rounded bg-light">
    ...
    <div class="row m-1">
        ...
        <div class="col">
            <input type="text" value="${participant.name}" form="saveParticipantChangesForm" class="form-control" id="nameInput"
    ...
    <div class="row m-1">
        ...
        <div class="col">
            <input type="email" value="${participant.info}" form="saveParticipantChangesForm" class="form-control" name="email"
                   id="emailInput" required
                   pattern="${requiredField}">
        </div>
    </div>
    <button type="submit" form="saveParticipantChangesForm" class="btn btn-success">${save}</button>
</div>
</body>
</html>
